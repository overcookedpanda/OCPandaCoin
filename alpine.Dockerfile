...
RUN strip ${OCPandaCoin_PREFIX}/bin/ocpandacoin-cli
RUN strip ${OCPandaCoin_PREFIX}/bin/ocpandacoind
RUN strip ${OCPandaCoin_PREFIX}/bin/ocpandacoin-tx
RUN strip ${OCPandaCoin_PREFIX}/bin/ocpandacoin-wallet
