 ...
 */
 CTestNetParams::CTestNetParams()
 {
     ...
     genesis = VeriBlock::CreateGenesisBlock(1658838850, 120451108, 0x1d07ffff, 1, "");
     consensus.hashGenesisBlock = genesis.GetHash();
     assert(consensus.hashGenesisBlock == uint256S("0x000000070582da55bd1f350f8a4d7fdd3d9a4155885c0f225fa43aed5c266c09"));
     assert(genesis.hashMerkleRoot == uint256S("0xbd1343d0ffe5bbe6b348de6373495068ee6f6e184a22bfbf1ea74527af36e799"));
...
CRegTestParams::CRegTestParams(const ArgsManager& args)
{
    ...
    genesis = VeriBlock::CreateGenesisBlock(1658838850, 1, 0x207fffff, 1, "");
    consensus.hashGenesisBlock = genesis.GetHash();
    assert(consensus.hashGenesisBlock == uint256S("0x42ba85b086762b24f8072c0762d7e9e063d9b2c144b743cb8e581b4acb575918"));
    assert(genesis.hashMerkleRoot == uint256S("0xb8fca700889aae9eeed46d1ca7ea49275e38db81a4b1a05969f071ad5bf9ddd4"));
