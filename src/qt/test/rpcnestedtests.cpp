...
void RPCNestedTests::rpcNestedTests()
{
    ...
    QVERIFY(result == "629c2aeee8e09f29ddede6576d54e8e9a43e5bd7df8cc0c4d94c9529dc3f67a4"); //this txid should be the first transaction within the mainnet genesis block
